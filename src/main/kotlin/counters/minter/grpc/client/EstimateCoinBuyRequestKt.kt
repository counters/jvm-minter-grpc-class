...
inline fun estimateCoinBuyRequest(block: counters.minter.grpc.client.EstimateCoinBuyRequestKt.Dsl.() -> Unit): counters.minter.grpc.client.EstimateCoinBuyRequest =
...
object EstimateCoinBuyRequestKt {
  ...
  class Dsl private constructor(
    @kotlin.jvm.JvmField private val _builder: counters.minter.grpc.client.EstimateCoinBuyRequest.Builder
  ) {
    companion object {
      @kotlin.jvm.JvmSynthetic
      @kotlin.PublishedApi
    ...
    fun com.google.protobuf.kotlin.DslList<kotlin.Long, RouteProxy>.clear() {
      _builder.clearRoute()
    }val buyCase: counters.minter.grpc.client.EstimateCoinBuyRequest.BuyCase
      @JvmName("getBuyCase")
    ...
    val sellCase: counters.minter.grpc.client.EstimateCoinBuyRequest.SellCase
      @JvmName("getSellCase")
    ...
    val commissionCase: counters.minter.grpc.client.EstimateCoinBuyRequest.CommissionCase
...
@kotlin.jvm.JvmSynthetic
inline fun counters.minter.grpc.client.EstimateCoinBuyRequest.copy(block: counters.minter.grpc.client.EstimateCoinBuyRequestKt.Dsl.() -> Unit): counters.minter.grpc.client.EstimateCoinBuyRequest =
