...
inline fun sellSwapPoolData(block: counters.minter.grpc.client.SellSwapPoolDataKt.Dsl.() -> Unit): counters.minter.grpc.client.SellSwapPoolData =
...
object SellSwapPoolDataKt {
  ...
  class Dsl private constructor(
    @kotlin.jvm.JvmField private val _builder: counters.minter.grpc.client.SellSwapPoolData.Builder
  ) {
    companion object {
      @kotlin.jvm.JvmSynthetic
      @kotlin.PublishedApi
...
@kotlin.jvm.JvmSynthetic
inline fun counters.minter.grpc.client.SellSwapPoolData.copy(block: counters.minter.grpc.client.SellSwapPoolDataKt.Dsl.() -> Unit): counters.minter.grpc.client.SellSwapPoolData =
