...
inline fun editMultisigData(block: counters.minter.grpc.client.EditMultisigDataKt.Dsl.() -> Unit): counters.minter.grpc.client.EditMultisigData =
...
object EditMultisigDataKt {
  ...
  class Dsl private constructor(
    @kotlin.jvm.JvmField private val _builder: counters.minter.grpc.client.EditMultisigData.Builder
  ) {
    companion object {
      @kotlin.jvm.JvmSynthetic
      @kotlin.PublishedApi
...
@kotlin.jvm.JvmSynthetic
inline fun counters.minter.grpc.client.EditMultisigData.copy(block: counters.minter.grpc.client.EditMultisigDataKt.Dsl.() -> Unit): counters.minter.grpc.client.EditMultisigData =
