...
@kotlin.jvm.JvmName("-initializeeditMultisigData")
public inline fun editMultisigData(block: counters.minter.grpc.client.EditMultisigDataKt.Dsl.() -> kotlin.Unit): counters.minter.grpc.client.EditMultisigData =
  counters.minter.grpc.client.EditMultisigDataKt.Dsl._create(counters.minter.grpc.client.EditMultisigData.newBuilder()).apply { block() }._build()
public object EditMultisigDataKt {
  @kotlin.OptIn(com.google.protobuf.kotlin.OnlyForUseByGeneratedProtoCode::class)
  @com.google.protobuf.kotlin.ProtoDslMarker
  public class Dsl private constructor(
    private val _builder: counters.minter.grpc.client.EditMultisigData.Builder
  ) {
    public companion object {
      @kotlin.jvm.JvmSynthetic
      @kotlin.PublishedApi
      internal fun _create(builder: counters.minter.grpc.client.EditMultisigData.Builder): Dsl = Dsl(builder)
    }

    @kotlin.jvm.JvmSynthetic
    @kotlin.PublishedApi
    internal fun _build(): counters.minter.grpc.client.EditMultisigData = _builder.build()
...
@kotlin.jvm.JvmSynthetic
public inline fun counters.minter.grpc.client.EditMultisigData.copy(block: counters.minter.grpc.client.EditMultisigDataKt.Dsl.() -> kotlin.Unit): counters.minter.grpc.client.EditMultisigData =
  counters.minter.grpc.client.EditMultisigDataKt.Dsl._create(this.toBuilder()).apply { block() }._build()
