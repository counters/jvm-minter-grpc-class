...
object ApiServiceGrpcKt {
  ...
  val frozenAllMethod: MethodDescriptor<FrozenAllRequest, FrozenResponse>
    @JvmStatic
    get() = ApiServiceGrpc.getFrozenAllMethod()
  ...
  val swapPoolsMethod: MethodDescriptor<SwapPoolsRequest, SwapPoolsResponse>
    @JvmStatic
    get() = ApiServiceGrpc.getSwapPoolsMethod()
  ...
  val bestTradeMethod: MethodDescriptor<BestTradeRequest, BestTradeResponse>
    @JvmStatic
    get() = ApiServiceGrpc.getBestTradeMethod()
  ...
  class ApiServiceCoroutineStub @JvmOverloads constructor(
     ...
     * @return The single response from the server.
     */
    suspend fun frozenAll(request: FrozenAllRequest, headers: Metadata = Metadata()): FrozenResponse
        = unaryRpc(
      channel,
      ApiServiceGrpc.getFrozenAllMethod(),
      request,
      callOptions,
      headers
    )
     ...
     * @return The single response from the server.
     */
    suspend fun swapPools(request: SwapPoolsRequest, headers: Metadata = Metadata()):
        SwapPoolsResponse = unaryRpc(
      channel,
      ApiServiceGrpc.getSwapPoolsMethod(),
      request,
      callOptions,
      headers
    )
     ...
     * @return The single response from the server.
     */
    suspend fun bestTrade(request: BestTradeRequest, headers: Metadata = Metadata()):
        BestTradeResponse = unaryRpc(
      channel,
      ApiServiceGrpc.getBestTradeMethod(),
      request,
      callOptions,
      headers
    )}
  ...
  abstract class ApiServiceCoroutineImplBase(
    ...
    /**
     * Returns the response to an RPC for api_pb.ApiService.FrozenAll.
     *
     * If this method fails with a [StatusException], the RPC will fail with the corresponding
     * [Status].  If this method fails with a [java.util.concurrent.CancellationException], the RPC
     * will fail
     ...
     * @param request The request from the client.
     */
    open suspend fun frozenAll(request: FrozenAllRequest): FrozenResponse = throw
        StatusException(UNIMPLEMENTED.withDescription("Method api_pb.ApiService.FrozenAll is unimplemented"))
    ...
    /**
     * Returns the response to an RPC for api_pb.ApiService.SwapPools.
     *
     * If this method fails with a [StatusException], the RPC will fail with the corresponding
     * [Status].  If this method fails with a [java.util.concurrent.CancellationException], the RPC
     * will fail
     ...
     * @param request The request from the client.
     */
    open suspend fun swapPools(request: SwapPoolsRequest): SwapPoolsResponse = throw
        StatusException(UNIMPLEMENTED.withDescription("Method api_pb.ApiService.SwapPools is unimplemented"))
    ...
    /**
     * Returns the response to an RPC for api_pb.ApiService.BestTrade.
     *
     * If this method fails with a [StatusException], the RPC will fail with the corresponding
     * [Status].  If this method fails with a [java.util.concurrent.CancellationException], the RPC
     * will fail
     ...
     * @param request The request from the client.
     */
    open suspend fun bestTrade(request: BestTradeRequest): BestTradeResponse = throw
        StatusException(UNIMPLEMENTED.withDescription("Method api_pb.ApiService.BestTrade is unimplemented"))
    ...
    final override fun bindService(): ServerServiceDefinition = builder(getServiceDescriptor())
      ...
      .addMethod(unaryServerMethodDefinition(
      context = this.context,
      descriptor = ApiServiceGrpc.getFrozenAllMethod(),
      implementation = ::frozenAll
    ))
      .addMethod(unaryServerMethodDefinition(
      context = this.context,
      ...
      .addMethod(unaryServerMethodDefinition(
      context = this.context,
      descriptor = ApiServiceGrpc.getSwapPoolsMethod(),
      implementation = ::swapPools
    ))
      .addMethod(unaryServerMethodDefinition(
      context = this.context,
      ...
      .addMethod(unaryServerMethodDefinition(
      context = this.context,
      descriptor = ApiServiceGrpc.getBestTradeMethod(),
      implementation = ::bestTrade
    )).build()
  }
}
