...
inline fun eventsRequest(block: counters.minter.grpc.client.EventsRequestKt.Dsl.() -> Unit): counters.minter.grpc.client.EventsRequest =
...
object EventsRequestKt {
  ...
  class Dsl private constructor(
    @kotlin.jvm.JvmField private val _builder: counters.minter.grpc.client.EventsRequest.Builder
  ) {
    companion object {
      @kotlin.jvm.JvmSynthetic
      @kotlin.PublishedApi
...
@kotlin.jvm.JvmSynthetic
inline fun counters.minter.grpc.client.EventsRequest.copy(block: counters.minter.grpc.client.EventsRequestKt.Dsl.() -> Unit): counters.minter.grpc.client.EventsRequest =
