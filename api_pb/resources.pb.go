...
type BlockResponse struct {
	...
	BlockReward      *wrapperspb.StringValue    `protobuf:"bytes,7,opt,name=block_reward,json=blockReward,proto3" json:"block_reward,omitempty"`
...
type FrozenResponse_Frozen struct {
	...
	Height             uint64                  `protobuf:"varint,1,opt,name=height,proto3" json:"height,omitempty"`
	Address            string                  `protobuf:"bytes,2,opt,name=address,proto3" json:"address,omitempty"`
	CandidateKey       *wrapperspb.StringValue `protobuf:"bytes,3,opt,name=candidate_key,json=candidateKey,proto3" json:"candidate_key,omitempty"`
