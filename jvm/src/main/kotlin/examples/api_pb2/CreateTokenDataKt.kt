...
public inline fun createTokenData(block: examples.api_pb2.CreateTokenDataKt.Dsl.() -> kotlin.Unit): examples.api_pb2.CreateTokenData =
  examples.api_pb2.CreateTokenDataKt.Dsl._create(examples.api_pb2.CreateTokenData.newBuilder()).apply { block() }._build()
public object CreateTokenDataKt {
  @kotlin.OptIn(com.google.protobuf.kotlin.OnlyForUseByGeneratedProtoCode::class)
  @com.google.protobuf.kotlin.ProtoDslMarker
  public class Dsl private constructor(
    private val _builder: examples.api_pb2.CreateTokenData.Builder
  ) {
    public companion object {
      @kotlin.jvm.JvmSynthetic
      @kotlin.PublishedApi
      internal fun _create(builder: examples.api_pb2.CreateTokenData.Builder): Dsl = Dsl(builder)
    }

    @kotlin.jvm.JvmSynthetic
    @kotlin.PublishedApi
    internal fun _build(): examples.api_pb2.CreateTokenData = _builder.build()
...
@kotlin.jvm.JvmSynthetic
public inline fun examples.api_pb2.CreateTokenData.copy(block: examples.api_pb2.CreateTokenDataKt.Dsl.() -> kotlin.Unit): examples.api_pb2.CreateTokenData =
  examples.api_pb2.CreateTokenDataKt.Dsl._create(this.toBuilder()).apply { block() }._build()
