...
public inline fun multisig(block: examples.api_pb2.MultisigKt.Dsl.() -> kotlin.Unit): examples.api_pb2.Multisig =
  examples.api_pb2.MultisigKt.Dsl._create(examples.api_pb2.Multisig.newBuilder()).apply { block() }._build()
public object MultisigKt {
  @kotlin.OptIn(com.google.protobuf.kotlin.OnlyForUseByGeneratedProtoCode::class)
  @com.google.protobuf.kotlin.ProtoDslMarker
  public class Dsl private constructor(
    private val _builder: examples.api_pb2.Multisig.Builder
  ) {
    public companion object {
      @kotlin.jvm.JvmSynthetic
      @kotlin.PublishedApi
      internal fun _create(builder: examples.api_pb2.Multisig.Builder): Dsl = Dsl(builder)
    }

    @kotlin.jvm.JvmSynthetic
    @kotlin.PublishedApi
    internal fun _build(): examples.api_pb2.Multisig = _builder.build()
...
@kotlin.jvm.JvmSynthetic
public inline fun examples.api_pb2.Multisig.copy(block: examples.api_pb2.MultisigKt.Dsl.() -> kotlin.Unit): examples.api_pb2.Multisig =
  examples.api_pb2.MultisigKt.Dsl._create(this.toBuilder()).apply { block() }._build()
