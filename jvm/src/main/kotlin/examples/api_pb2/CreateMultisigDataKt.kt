...
public inline fun createMultisigData(block: examples.api_pb2.CreateMultisigDataKt.Dsl.() -> kotlin.Unit): examples.api_pb2.CreateMultisigData =
  examples.api_pb2.CreateMultisigDataKt.Dsl._create(examples.api_pb2.CreateMultisigData.newBuilder()).apply { block() }._build()
public object CreateMultisigDataKt {
  @kotlin.OptIn(com.google.protobuf.kotlin.OnlyForUseByGeneratedProtoCode::class)
  @com.google.protobuf.kotlin.ProtoDslMarker
  public class Dsl private constructor(
    private val _builder: examples.api_pb2.CreateMultisigData.Builder
  ) {
    public companion object {
      @kotlin.jvm.JvmSynthetic
      @kotlin.PublishedApi
      internal fun _create(builder: examples.api_pb2.CreateMultisigData.Builder): Dsl = Dsl(builder)
    }

    @kotlin.jvm.JvmSynthetic
    @kotlin.PublishedApi
    internal fun _build(): examples.api_pb2.CreateMultisigData = _builder.build()
...
@kotlin.jvm.JvmSynthetic
public inline fun examples.api_pb2.CreateMultisigData.copy(block: examples.api_pb2.CreateMultisigDataKt.Dsl.() -> kotlin.Unit): examples.api_pb2.CreateMultisigData =
  examples.api_pb2.CreateMultisigDataKt.Dsl._create(this.toBuilder()).apply { block() }._build()
