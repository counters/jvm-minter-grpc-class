...
public inline fun editMultisigData(block: examples.api_pb2.EditMultisigDataKt.Dsl.() -> kotlin.Unit): examples.api_pb2.EditMultisigData =
  examples.api_pb2.EditMultisigDataKt.Dsl._create(examples.api_pb2.EditMultisigData.newBuilder()).apply { block() }._build()
public object EditMultisigDataKt {
  @kotlin.OptIn(com.google.protobuf.kotlin.OnlyForUseByGeneratedProtoCode::class)
  @com.google.protobuf.kotlin.ProtoDslMarker
  public class Dsl private constructor(
    private val _builder: examples.api_pb2.EditMultisigData.Builder
  ) {
    public companion object {
      @kotlin.jvm.JvmSynthetic
      @kotlin.PublishedApi
      internal fun _create(builder: examples.api_pb2.EditMultisigData.Builder): Dsl = Dsl(builder)
    }

    @kotlin.jvm.JvmSynthetic
    @kotlin.PublishedApi
    internal fun _build(): examples.api_pb2.EditMultisigData = _builder.build()
...
@kotlin.jvm.JvmSynthetic
public inline fun examples.api_pb2.EditMultisigData.copy(block: examples.api_pb2.EditMultisigDataKt.Dsl.() -> kotlin.Unit): examples.api_pb2.EditMultisigData =
  examples.api_pb2.EditMultisigDataKt.Dsl._create(this.toBuilder()).apply { block() }._build()
