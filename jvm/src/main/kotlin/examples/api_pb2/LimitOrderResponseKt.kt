...
public inline fun limitOrderResponse(block: examples.api_pb2.LimitOrderResponseKt.Dsl.() -> kotlin.Unit): examples.api_pb2.LimitOrderResponse =
  examples.api_pb2.LimitOrderResponseKt.Dsl._create(examples.api_pb2.LimitOrderResponse.newBuilder()).apply { block() }._build()
public object LimitOrderResponseKt {
  @kotlin.OptIn(com.google.protobuf.kotlin.OnlyForUseByGeneratedProtoCode::class)
  @com.google.protobuf.kotlin.ProtoDslMarker
  public class Dsl private constructor(
    private val _builder: examples.api_pb2.LimitOrderResponse.Builder
  ) {
    public companion object {
      @kotlin.jvm.JvmSynthetic
      @kotlin.PublishedApi
      internal fun _create(builder: examples.api_pb2.LimitOrderResponse.Builder): Dsl = Dsl(builder)
    }

    @kotlin.jvm.JvmSynthetic
    @kotlin.PublishedApi
    internal fun _build(): examples.api_pb2.LimitOrderResponse = _builder.build()
     ...
     */
    public var coinSell: examples.api_pb2.Coin
      @JvmName("getCoinSell")
     ...
     */
    public var coinBuy: examples.api_pb2.Coin
      @JvmName("getCoinBuy")
...
@kotlin.jvm.JvmSynthetic
public inline fun examples.api_pb2.LimitOrderResponse.copy(block: examples.api_pb2.LimitOrderResponseKt.Dsl.() -> kotlin.Unit): examples.api_pb2.LimitOrderResponse =
  examples.api_pb2.LimitOrderResponseKt.Dsl._create(this.toBuilder()).apply { block() }._build()
