...
public inline fun limitOrdersRequest(block: examples.api_pb2.LimitOrdersRequestKt.Dsl.() -> kotlin.Unit): examples.api_pb2.LimitOrdersRequest =
  examples.api_pb2.LimitOrdersRequestKt.Dsl._create(examples.api_pb2.LimitOrdersRequest.newBuilder()).apply { block() }._build()
public object LimitOrdersRequestKt {
  @kotlin.OptIn(com.google.protobuf.kotlin.OnlyForUseByGeneratedProtoCode::class)
  @com.google.protobuf.kotlin.ProtoDslMarker
  public class Dsl private constructor(
    private val _builder: examples.api_pb2.LimitOrdersRequest.Builder
  ) {
    public companion object {
      @kotlin.jvm.JvmSynthetic
      @kotlin.PublishedApi
      internal fun _create(builder: examples.api_pb2.LimitOrdersRequest.Builder): Dsl = Dsl(builder)
    }

    @kotlin.jvm.JvmSynthetic
    @kotlin.PublishedApi
    internal fun _build(): examples.api_pb2.LimitOrdersRequest = _builder.build()
...
@kotlin.jvm.JvmSynthetic
public inline fun examples.api_pb2.LimitOrdersRequest.copy(block: examples.api_pb2.LimitOrdersRequestKt.Dsl.() -> kotlin.Unit): examples.api_pb2.LimitOrdersRequest =
  examples.api_pb2.LimitOrdersRequestKt.Dsl._create(this.toBuilder()).apply { block() }._build()
