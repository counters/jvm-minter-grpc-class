...
public inline fun statusResponse(block: examples.api_pb2.StatusResponseKt.Dsl.() -> kotlin.Unit): examples.api_pb2.StatusResponse =
  examples.api_pb2.StatusResponseKt.Dsl._create(examples.api_pb2.StatusResponse.newBuilder()).apply { block() }._build()
public object StatusResponseKt {
  @kotlin.OptIn(com.google.protobuf.kotlin.OnlyForUseByGeneratedProtoCode::class)
  @com.google.protobuf.kotlin.ProtoDslMarker
  public class Dsl private constructor(
    private val _builder: examples.api_pb2.StatusResponse.Builder
  ) {
    public companion object {
      @kotlin.jvm.JvmSynthetic
      @kotlin.PublishedApi
      internal fun _create(builder: examples.api_pb2.StatusResponse.Builder): Dsl = Dsl(builder)
    }

    @kotlin.jvm.JvmSynthetic
    @kotlin.PublishedApi
    internal fun _build(): examples.api_pb2.StatusResponse = _builder.build()
...
@kotlin.jvm.JvmSynthetic
public inline fun examples.api_pb2.StatusResponse.copy(block: examples.api_pb2.StatusResponseKt.Dsl.() -> kotlin.Unit): examples.api_pb2.StatusResponse =
  examples.api_pb2.StatusResponseKt.Dsl._create(this.toBuilder()).apply { block() }._build()
