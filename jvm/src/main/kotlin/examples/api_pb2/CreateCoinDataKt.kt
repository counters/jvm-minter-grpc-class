...
public inline fun createCoinData(block: examples.api_pb2.CreateCoinDataKt.Dsl.() -> kotlin.Unit): examples.api_pb2.CreateCoinData =
  examples.api_pb2.CreateCoinDataKt.Dsl._create(examples.api_pb2.CreateCoinData.newBuilder()).apply { block() }._build()
public object CreateCoinDataKt {
  @kotlin.OptIn(com.google.protobuf.kotlin.OnlyForUseByGeneratedProtoCode::class)
  @com.google.protobuf.kotlin.ProtoDslMarker
  public class Dsl private constructor(
    private val _builder: examples.api_pb2.CreateCoinData.Builder
  ) {
    public companion object {
      @kotlin.jvm.JvmSynthetic
      @kotlin.PublishedApi
      internal fun _create(builder: examples.api_pb2.CreateCoinData.Builder): Dsl = Dsl(builder)
    }

    @kotlin.jvm.JvmSynthetic
    @kotlin.PublishedApi
    internal fun _build(): examples.api_pb2.CreateCoinData = _builder.build()
...
@kotlin.jvm.JvmSynthetic
public inline fun examples.api_pb2.CreateCoinData.copy(block: examples.api_pb2.CreateCoinDataKt.Dsl.() -> kotlin.Unit): examples.api_pb2.CreateCoinData =
  examples.api_pb2.CreateCoinDataKt.Dsl._create(this.toBuilder()).apply { block() }._build()
