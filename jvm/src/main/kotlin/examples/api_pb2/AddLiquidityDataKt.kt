...
public inline fun addLiquidityData(block: examples.api_pb2.AddLiquidityDataKt.Dsl.() -> kotlin.Unit): examples.api_pb2.AddLiquidityData =
  examples.api_pb2.AddLiquidityDataKt.Dsl._create(examples.api_pb2.AddLiquidityData.newBuilder()).apply { block() }._build()
public object AddLiquidityDataKt {
  @kotlin.OptIn(com.google.protobuf.kotlin.OnlyForUseByGeneratedProtoCode::class)
  @com.google.protobuf.kotlin.ProtoDslMarker
  public class Dsl private constructor(
    private val _builder: examples.api_pb2.AddLiquidityData.Builder
  ) {
    public companion object {
      @kotlin.jvm.JvmSynthetic
      @kotlin.PublishedApi
      internal fun _create(builder: examples.api_pb2.AddLiquidityData.Builder): Dsl = Dsl(builder)
    }

    @kotlin.jvm.JvmSynthetic
    @kotlin.PublishedApi
    internal fun _build(): examples.api_pb2.AddLiquidityData = _builder.build()
...
@kotlin.jvm.JvmSynthetic
public inline fun examples.api_pb2.AddLiquidityData.copy(block: examples.api_pb2.AddLiquidityDataKt.Dsl.() -> kotlin.Unit): examples.api_pb2.AddLiquidityData =
  examples.api_pb2.AddLiquidityDataKt.Dsl._create(this.toBuilder()).apply { block() }._build()
