...
public inline fun voteCommissionData(block: examples.api_pb2.VoteCommissionDataKt.Dsl.() -> kotlin.Unit): examples.api_pb2.VoteCommissionData =
  examples.api_pb2.VoteCommissionDataKt.Dsl._create(examples.api_pb2.VoteCommissionData.newBuilder()).apply { block() }._build()
public object VoteCommissionDataKt {
  @kotlin.OptIn(com.google.protobuf.kotlin.OnlyForUseByGeneratedProtoCode::class)
  @com.google.protobuf.kotlin.ProtoDslMarker
  public class Dsl private constructor(
    private val _builder: examples.api_pb2.VoteCommissionData.Builder
  ) {
    public companion object {
      @kotlin.jvm.JvmSynthetic
      @kotlin.PublishedApi
      internal fun _create(builder: examples.api_pb2.VoteCommissionData.Builder): Dsl = Dsl(builder)
    }

    @kotlin.jvm.JvmSynthetic
    @kotlin.PublishedApi
    internal fun _build(): examples.api_pb2.VoteCommissionData = _builder.build()
...
@kotlin.jvm.JvmSynthetic
public inline fun examples.api_pb2.VoteCommissionData.copy(block: examples.api_pb2.VoteCommissionDataKt.Dsl.() -> kotlin.Unit): examples.api_pb2.VoteCommissionData =
  examples.api_pb2.VoteCommissionDataKt.Dsl._create(this.toBuilder()).apply { block() }._build()
