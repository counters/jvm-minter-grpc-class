...
public inline fun coinInfoResponse(block: examples.api_pb2.CoinInfoResponseKt.Dsl.() -> kotlin.Unit): examples.api_pb2.CoinInfoResponse =
  examples.api_pb2.CoinInfoResponseKt.Dsl._create(examples.api_pb2.CoinInfoResponse.newBuilder()).apply { block() }._build()
public object CoinInfoResponseKt {
  @kotlin.OptIn(com.google.protobuf.kotlin.OnlyForUseByGeneratedProtoCode::class)
  @com.google.protobuf.kotlin.ProtoDslMarker
  public class Dsl private constructor(
    private val _builder: examples.api_pb2.CoinInfoResponse.Builder
  ) {
    public companion object {
      @kotlin.jvm.JvmSynthetic
      @kotlin.PublishedApi
      internal fun _create(builder: examples.api_pb2.CoinInfoResponse.Builder): Dsl = Dsl(builder)
    }

    @kotlin.jvm.JvmSynthetic
    @kotlin.PublishedApi
    internal fun _build(): examples.api_pb2.CoinInfoResponse = _builder.build()
...
@kotlin.jvm.JvmSynthetic
public inline fun examples.api_pb2.CoinInfoResponse.copy(block: examples.api_pb2.CoinInfoResponseKt.Dsl.() -> kotlin.Unit): examples.api_pb2.CoinInfoResponse =
  examples.api_pb2.CoinInfoResponseKt.Dsl._create(this.toBuilder()).apply { block() }._build()
