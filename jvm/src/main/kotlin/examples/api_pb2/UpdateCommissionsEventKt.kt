...
public inline fun updateCommissionsEvent(block: examples.api_pb2.UpdateCommissionsEventKt.Dsl.() -> kotlin.Unit): examples.api_pb2.UpdateCommissionsEvent =
  examples.api_pb2.UpdateCommissionsEventKt.Dsl._create(examples.api_pb2.UpdateCommissionsEvent.newBuilder()).apply { block() }._build()
public object UpdateCommissionsEventKt {
  @kotlin.OptIn(com.google.protobuf.kotlin.OnlyForUseByGeneratedProtoCode::class)
  @com.google.protobuf.kotlin.ProtoDslMarker
  public class Dsl private constructor(
    private val _builder: examples.api_pb2.UpdateCommissionsEvent.Builder
  ) {
    public companion object {
      @kotlin.jvm.JvmSynthetic
      @kotlin.PublishedApi
      internal fun _create(builder: examples.api_pb2.UpdateCommissionsEvent.Builder): Dsl = Dsl(builder)
    }

    @kotlin.jvm.JvmSynthetic
    @kotlin.PublishedApi
    internal fun _build(): examples.api_pb2.UpdateCommissionsEvent = _builder.build()
...
@kotlin.jvm.JvmSynthetic
public inline fun examples.api_pb2.UpdateCommissionsEvent.copy(block: examples.api_pb2.UpdateCommissionsEventKt.Dsl.() -> kotlin.Unit): examples.api_pb2.UpdateCommissionsEvent =
  examples.api_pb2.UpdateCommissionsEventKt.Dsl._create(this.toBuilder()).apply { block() }._build()
