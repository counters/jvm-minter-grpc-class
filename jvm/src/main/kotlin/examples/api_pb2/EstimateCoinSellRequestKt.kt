...
public inline fun estimateCoinSellRequest(block: examples.api_pb2.EstimateCoinSellRequestKt.Dsl.() -> kotlin.Unit): examples.api_pb2.EstimateCoinSellRequest =
  examples.api_pb2.EstimateCoinSellRequestKt.Dsl._create(examples.api_pb2.EstimateCoinSellRequest.newBuilder()).apply { block() }._build()
public object EstimateCoinSellRequestKt {
  @kotlin.OptIn(com.google.protobuf.kotlin.OnlyForUseByGeneratedProtoCode::class)
  @com.google.protobuf.kotlin.ProtoDslMarker
  public class Dsl private constructor(
    private val _builder: examples.api_pb2.EstimateCoinSellRequest.Builder
  ) {
    public companion object {
      @kotlin.jvm.JvmSynthetic
      @kotlin.PublishedApi
      internal fun _create(builder: examples.api_pb2.EstimateCoinSellRequest.Builder): Dsl = Dsl(builder)
    }

    @kotlin.jvm.JvmSynthetic
    @kotlin.PublishedApi
    internal fun _build(): examples.api_pb2.EstimateCoinSellRequest = _builder.build()
    ...
    public fun com.google.protobuf.kotlin.DslList<kotlin.Long, RouteProxy>.clear() {
      _builder.clearRoute()
    }public val buyCase: examples.api_pb2.EstimateCoinSellRequest.BuyCase
      @JvmName("getBuyCase")
    ...
    public val sellCase: examples.api_pb2.EstimateCoinSellRequest.SellCase
      @JvmName("getSellCase")
    ...
    public val commissionCase: examples.api_pb2.EstimateCoinSellRequest.CommissionCase
...
@kotlin.jvm.JvmSynthetic
public inline fun examples.api_pb2.EstimateCoinSellRequest.copy(block: examples.api_pb2.EstimateCoinSellRequestKt.Dsl.() -> kotlin.Unit): examples.api_pb2.EstimateCoinSellRequest =
  examples.api_pb2.EstimateCoinSellRequestKt.Dsl._create(this.toBuilder()).apply { block() }._build()
