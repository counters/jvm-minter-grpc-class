...
public inline fun estimateCoinSellAllRequest(block: examples.api_pb2.EstimateCoinSellAllRequestKt.Dsl.() -> kotlin.Unit): examples.api_pb2.EstimateCoinSellAllRequest =
  examples.api_pb2.EstimateCoinSellAllRequestKt.Dsl._create(examples.api_pb2.EstimateCoinSellAllRequest.newBuilder()).apply { block() }._build()
public object EstimateCoinSellAllRequestKt {
  @kotlin.OptIn(com.google.protobuf.kotlin.OnlyForUseByGeneratedProtoCode::class)
  @com.google.protobuf.kotlin.ProtoDslMarker
  public class Dsl private constructor(
    private val _builder: examples.api_pb2.EstimateCoinSellAllRequest.Builder
  ) {
    public companion object {
      @kotlin.jvm.JvmSynthetic
      @kotlin.PublishedApi
      internal fun _create(builder: examples.api_pb2.EstimateCoinSellAllRequest.Builder): Dsl = Dsl(builder)
    }

    @kotlin.jvm.JvmSynthetic
    @kotlin.PublishedApi
    internal fun _build(): examples.api_pb2.EstimateCoinSellAllRequest = _builder.build()
    ...
    public fun com.google.protobuf.kotlin.DslList<kotlin.Long, RouteProxy>.clear() {
      _builder.clearRoute()
    }public val buyCase: examples.api_pb2.EstimateCoinSellAllRequest.BuyCase
      @JvmName("getBuyCase")
    ...
    public val sellCase: examples.api_pb2.EstimateCoinSellAllRequest.SellCase
      @JvmName("getSellCase")
...
@kotlin.jvm.JvmSynthetic
public inline fun examples.api_pb2.EstimateCoinSellAllRequest.copy(block: examples.api_pb2.EstimateCoinSellAllRequestKt.Dsl.() -> kotlin.Unit): examples.api_pb2.EstimateCoinSellAllRequest =
  examples.api_pb2.EstimateCoinSellAllRequestKt.Dsl._create(this.toBuilder()).apply { block() }._build()
