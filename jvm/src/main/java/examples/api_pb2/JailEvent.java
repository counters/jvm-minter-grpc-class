...
private static final long serialVersionUID = 0L;
  ...
  public static final com.google.protobuf.Descriptors.Descriptor
      getDescriptor() {
    return examples.api_pb2.Events.internal_static_api_pb_JailEvent_descriptor;
  }

  @java.lang.Override
  protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      internalGetFieldAccessorTable() {
    return examples.api_pb2.Events.internal_static_api_pb_JailEvent_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            examples.api_pb2.JailEvent.class, examples.api_pb2.JailEvent.Builder.class);
  }
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    if (!(obj instanceof examples.api_pb2.JailEvent)) {
      return super.equals(obj);
    }
    examples.api_pb2.JailEvent other = (examples.api_pb2.JailEvent) obj;
  ...
  public static examples.api_pb2.JailEvent parseFrom(
  ...
  public static examples.api_pb2.JailEvent parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static examples.api_pb2.JailEvent parseFrom(
  ...
  public static examples.api_pb2.JailEvent parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static examples.api_pb2.JailEvent parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
        .parseDelimitedWithIOException(PARSER, input);
  }
  public static examples.api_pb2.JailEvent parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static Builder newBuilder(examples.api_pb2.JailEvent prototype) {
  ...
  public static final class Builder extends
      ...
      examples.api_pb2.JailEventOrBuilder {
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return examples.api_pb2.Events.internal_static_api_pb_JailEvent_descriptor;
    }
    ...
    // Construct using examples.api_pb2.JailEvent.newBuilder()
    private Builder() {
    ...
    @java.lang.Override
    public examples.api_pb2.JailEvent getDefaultInstanceForType() {
      return examples.api_pb2.JailEvent.getDefaultInstance();
    }

    @java.lang.Override
    public examples.api_pb2.JailEvent build() {
      examples.api_pb2.JailEvent result = buildPartial();
    ...
    @java.lang.Override
    public examples.api_pb2.JailEvent buildPartial() {
      examples.api_pb2.JailEvent result = new examples.api_pb2.JailEvent(this);
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof examples.api_pb2.JailEvent) {
        return mergeFrom((examples.api_pb2.JailEvent)other);
      } else {
    ...
    public Builder mergeFrom(examples.api_pb2.JailEvent other) {
      if (other == examples.api_pb2.JailEvent.getDefaultInstance()) return this;
    ...
    public Builder mergeFrom(
        ...
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      examples.api_pb2.JailEvent parsedMessage = null;
      try {
        parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
      } catch (com.google.protobuf.InvalidProtocolBufferException e) {
        parsedMessage = (examples.api_pb2.JailEvent) e.getUnfinishedMessage();
  ...
  private static final examples.api_pb2.JailEvent DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new examples.api_pb2.JailEvent();
  }

  public static examples.api_pb2.JailEvent getDefaultInstance() {
