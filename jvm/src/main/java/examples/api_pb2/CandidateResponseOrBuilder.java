...
public interface CandidateResponseOrBuilder extends
   ...
   */
  java.util.List<examples.api_pb2.CandidateResponse.Stake> 
      getStakesList();
  /**
   * <pre>
   * List of stakes. Note: filled in when request includes_stakes
   ...
   * <code>repeated .api_pb.CandidateResponse.Stake stakes = 5 [json_name = "stakes"];</code>
   */
  examples.api_pb2.CandidateResponse.Stake getStakes(int index);
  /**
   * <pre>
   * List of stakes. Note: filled in when request includes_stakes
   * </pre>
   ...
   * <code>repeated .api_pb.CandidateResponse.Stake stakes = 5 [json_name = "stakes"];</code>
   */
  java.util.List<? extends examples.api_pb2.CandidateResponse.StakeOrBuilder> 
   ...
   * <code>repeated .api_pb.CandidateResponse.Stake stakes = 5 [json_name = "stakes"];</code>
   */
  examples.api_pb2.CandidateResponse.StakeOrBuilder getStakesOrBuilder(
      int index);
