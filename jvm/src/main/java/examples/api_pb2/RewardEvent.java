...
private static final long serialVersionUID = 0L;
  ...
  public static final com.google.protobuf.Descriptors.Descriptor
      getDescriptor() {
    return examples.api_pb2.Events.internal_static_api_pb_RewardEvent_descriptor;
  }

  @java.lang.Override
  protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      internalGetFieldAccessorTable() {
    return examples.api_pb2.Events.internal_static_api_pb_RewardEvent_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            examples.api_pb2.RewardEvent.class, examples.api_pb2.RewardEvent.Builder.class);
  }
  ...
  public enum Role
    ...
    public static final com.google.protobuf.Descriptors.EnumDescriptor
        getDescriptor() {
      return examples.api_pb2.RewardEvent.getDescriptor().getEnumTypes().get(0);
    }
   ...
   * @return The role.
   */
  @java.lang.Override public examples.api_pb2.RewardEvent.Role getRole() {
    @SuppressWarnings("deprecation")
    examples.api_pb2.RewardEvent.Role result = examples.api_pb2.RewardEvent.Role.valueOf(role_);
    return result == null ? examples.api_pb2.RewardEvent.Role.UNRECOGNIZED : result;
  }
  ...
  public void writeTo(com.google.protobuf.CodedOutputStream output)
    ...
    if (role_ != examples.api_pb2.RewardEvent.Role.Validator.getNumber()) {
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    if (!(obj instanceof examples.api_pb2.RewardEvent)) {
      return super.equals(obj);
    }
    examples.api_pb2.RewardEvent other = (examples.api_pb2.RewardEvent) obj;
  ...
  public static examples.api_pb2.RewardEvent parseFrom(
  ...
  public static examples.api_pb2.RewardEvent parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static examples.api_pb2.RewardEvent parseFrom(
  ...
  public static examples.api_pb2.RewardEvent parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static examples.api_pb2.RewardEvent parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
        .parseDelimitedWithIOException(PARSER, input);
  }
  public static examples.api_pb2.RewardEvent parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static Builder newBuilder(examples.api_pb2.RewardEvent prototype) {
  ...
  public static final class Builder extends
      ...
      examples.api_pb2.RewardEventOrBuilder {
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return examples.api_pb2.Events.internal_static_api_pb_RewardEvent_descriptor;
    }
    ...
    // Construct using examples.api_pb2.RewardEvent.newBuilder()
    private Builder() {
    ...
    @java.lang.Override
    public examples.api_pb2.RewardEvent getDefaultInstanceForType() {
      return examples.api_pb2.RewardEvent.getDefaultInstance();
    }

    @java.lang.Override
    public examples.api_pb2.RewardEvent build() {
      examples.api_pb2.RewardEvent result = buildPartial();
    ...
    @java.lang.Override
    public examples.api_pb2.RewardEvent buildPartial() {
      examples.api_pb2.RewardEvent result = new examples.api_pb2.RewardEvent(this);
      result.role_ = role_;
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof examples.api_pb2.RewardEvent) {
        return mergeFrom((examples.api_pb2.RewardEvent)other);
      } else {
    ...
    public Builder mergeFrom(examples.api_pb2.RewardEvent other) {
      if (other == examples.api_pb2.RewardEvent.getDefaultInstance()) return this;
      if (other.role_ != 0) {
    ...
    public Builder mergeFrom(
        ...
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      examples.api_pb2.RewardEvent parsedMessage = null;
      try {
        parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
      } catch (com.google.protobuf.InvalidProtocolBufferException e) {
        parsedMessage = (examples.api_pb2.RewardEvent) e.getUnfinishedMessage();
     ...
     */
    @java.lang.Override
    public examples.api_pb2.RewardEvent.Role getRole() {
      @SuppressWarnings("deprecation")
      examples.api_pb2.RewardEvent.Role result = examples.api_pb2.RewardEvent.Role.valueOf(role_);
      return result == null ? examples.api_pb2.RewardEvent.Role.UNRECOGNIZED : result;
    }
     ...
     * @return This builder for chaining.
     */
    public Builder setRole(examples.api_pb2.RewardEvent.Role value) {
      if (value == null) {
  ...
  private static final examples.api_pb2.RewardEvent DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new examples.api_pb2.RewardEvent();
  }

  public static examples.api_pb2.RewardEvent getDefaultInstance() {
