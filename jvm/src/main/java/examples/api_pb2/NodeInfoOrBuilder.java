...
public interface NodeInfoOrBuilder extends
   ...
   */
  examples.api_pb2.NodeInfo.ProtocolVersion getProtocolVersion();
  /**
   * <code>.api_pb.NodeInfo.ProtocolVersion protocol_version = 8 [json_name = "protocolVersion"];</code>
   */
  examples.api_pb2.NodeInfo.ProtocolVersionOrBuilder getProtocolVersionOrBuilder();
   ...
   * @return The other.
   */
  examples.api_pb2.NodeInfo.Other getOther();
  /**
   * <code>.api_pb.NodeInfo.Other other = 7 [json_name = "other"];</code>
   */
  examples.api_pb2.NodeInfo.OtherOrBuilder getOtherOrBuilder();
}
